...
import PharmacyLocation from "./PharmacyLocation/PharmacyLocation";
import OrderMedicine from "./OrderMedicine/OrderMedicine";

const swal = require('sweetalert2')
const PharmacistProfile = ({ id }) => {
    ...
    const fetchPharmacistData = () => {
        axios.get(`${ip}/api/pharmacist-profile/${id}/`, {
            headers: {
    ...
    }, [bioText, isEditing, pharmacistData]);
    ...
    return (
        <>
            {loading ?
                <Loading />
                :
                <section className="pharmacist-profile-section" style={viewFullImage || viewPostForm ? {
                    overflow: 'hidden',
                        ...
                        <>
                            <div className="pharmacist-info">
                                ...
                                <div className="details">
                                    {/* <span className="date-joined"><span>Date Joined:</span> {formatDate(new Date(pharmacistData.date_joined).toLocaleDateString())}</span> */}
                                    <h4>{pharmacistData.username}</h4>
                                    <p><span>Email: </span>{pharmacistData.email}</p>
                                    <p><span>Phone: </span>{pharmacistData.phone}</p>
                                    <p><span>Address: </span>{pharmacistData.address}</p>
                            ...
                            <div className="main-container">
                                ...
                                <div className="pharmacist-profile-contents">

                                    {/* ========== OVERVIEW ========== */}
                                    <div className={`content overview ${activeContent === 'overview' ? 'active' : ''}`}>
                                        <h4>Biography of {pharmacistData.username}</h4>
                                        {pharmacistData.speciality && <span>Field: {pharmacistData.speciality}</span>}
                                        <pre>{pharmacistData.bio}</pre>

                                        <h4>Medical Background</h4>
                                        <pre>{pharmacistData.medical_background}</pre>
                                    </div>
                                    ...
                                    {/* ========== Order Medicine ========== */}
                                    <div className={`order-medicine ${activeContent === 'order-medicine' ? 'active' : ''}`}>
                                        {/* <div className="left">
                                            ...
                                            <div className="pharmacist-details information">
                                                ...
                                                <div className="info">
                                                    ...
                                                    <div className="details">
                                                        <p>{pharmacistData.username}</p>
                                                        <span>{pharmacistData.speciality}</span>
                                                    </div>
                                                </div>

                                                <p className="working-hours"><span>Available from: </span>{pharmacistData.opening_time} - {pharmacistData.closing_time}</p>
                                            </div>
                                        </div>

                                        <div className="appointment-form-container">
                                            <h6>Order Medicine Form</h6>
                                        ...
                                        {/* <BookAppointment pharmacistData={pharmacistData} /> */}
                                        <OrderMedicine pharmacyId={id} />
                                    </div>
                                </div>
                            </div>
