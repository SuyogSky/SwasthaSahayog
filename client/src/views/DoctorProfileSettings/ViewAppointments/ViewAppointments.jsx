                        ...
                        {appointments ? appointments.map((appointment, index) => {
                            return (
                                <tr>
                                    ...
                                    <td className='action'><IoEyeOutline className='details' /> <p className='approve' onClick={() => approveAppointment(appointment.id)}><span>✔</span></p> <RxCrossCircled className='reject' /></td>
                                </tr>
                            )
                        })
                            :
