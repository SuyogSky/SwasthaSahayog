...
function SideBar({ doctorData }) {
  ...
  const calculateCompletionPercentage = () => {
    ...
    const nullFields = Object.values(doctorData).filter(value => value === null || value === undefined || value.length === 0).length;
    ...
    <div className="doctor-sidebar">
      <div className="top">
        <div className="container">
          <div className="contents">
            ...
            <p>{doctorData.speciality || 'Not Set'}</p>
          </div>
        </div>
      </div>
      ...
      <div className="navigation-menu">
        <ul>
          ...
          <li><Link to='/doctor/edit-profile' className={isActiveLink('/doctor/edit-profile') ? 'active' : ''}><MdOutlineManageAccounts />Profile Settings</Link></li>
