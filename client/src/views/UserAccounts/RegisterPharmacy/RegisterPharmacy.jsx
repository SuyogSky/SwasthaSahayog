...
function RegisterPharmacy() {
  ...
  const { registerPharmacist } = useContext(AuthContext)
  ...
  const handleSubmit = async (e) => {
    ...
    if (email, username, phone, city, license, password, password2) {
      if (phone.length !== 10) {
        ...
        formData.append('pharmacy_license', license);
        ...
        try {
          ...
          if (response.status === 200) {
            ...
            setDisplayOTP(true)
            swal.fire({
              title: "An OTP is sent in your mail.",
              icon: "success",
              toast: true,
              timer: 6000,
              position: "top-right",
  ...
  return (
    <section className="register-pharmacy-section">
      <div className="banner">
        <div className="text">
          <h2>Join Our Pharmacist's Team</h2>
        ...
        <div className="form-container">
          ...
          <div className="content">
            ...
            <form action="" onSubmit={handleSubmit}>
              ...
              <label htmlFor="license">Pharmacy License <span>*</span></label>
